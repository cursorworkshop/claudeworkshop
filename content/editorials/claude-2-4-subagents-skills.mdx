---
title: 'Claude 2.4: Subagents, Skills, and What They Mean for Your Workflow'
description: "Claude 2.4 introduces subagents, skills, and image generation. Here's how these features fit into a structured AI development workflow."
...
## What's New in Claude 2.4

Released January 22, 2026, Claude 2.4 focuses on agent infrastructure. The three major additions:
...
Claude includes default subagents for:
...
_We train teams to use these features effectively. [Contact us](/contact) for hands-on training with Claude 2.4._
